...
SphinxDataFilePaths = tuple[
    AcousticParametersDirectoryPath, LanguageModelFilePath, PhonemeDictionaryFilePath
]
...
def recognize(
    ...
    assert keyword_entries is None or all(
        isinstance(keyword, (type(""), type(""))) and 0 <= sensitivity <= 1
