...
_call_return_callbacks: Dict[
    float, Tuple[Callable[..., Any], Optional[Callable[..., Any]]]
] = {}
_call_number: int = 0
...
_shutdown: Optional[gvt.Greenlet] = (
    None  # Later assigned as global by _websocket_close()
)
...
def _mock_call(
    name: str, args: Any
) -> Callable[[Optional[Callable[..., Any]], Optional[Callable[..., Any]]], Any]:
