    ...
    def extract_into_diagram(self, el_id: int):
        ...
        if position.parent:
            ...
            ret = EditablePartial.from_call(
                railroad.NonTerminal, text=position.name, href=href
            )
...
def _visible_exprs(exprs: Iterable[pyparsing.ParserElement]):
    ...
    return [e for e in exprs if not isinstance(e, non_diagramming_exprs)]
...
def _to_diagram_element(
    ...
    if _worth_extracting(element):
        ...
        if looked_up and looked_up.name is not None:
            ...
            ret = EditablePartial.from_call(
                railroad.NonTerminal, text=looked_up.name, href=href
            )
            return ret
    ...
    if el_id in lookup and lookup[el_id].extract and lookup[el_id].complete:
        ...
        if ret is not None:
            ...
            ret = EditablePartial.from_call(railroad.NonTerminal, text=text, href=href)
