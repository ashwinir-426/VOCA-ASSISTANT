...
class WampProtocol(BaseProtocol):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.session_id = "".join(
            [random.choice(string.digits + string.letters) for i in range_type(16)]
        )
    ...
    def rpc_call(self, data):
        ...
        try:
            ...
            result_msg = [self.MSG_CALL_ERROR, call_id] + self._get_exception_info(e)
    ...
    def pubsub_action(self, data):
        ...
        if action == self.MSG_SUBSCRIBE and len(data) == 2:
            ...
            self.server.channels.unsubscribe(data[1], self.handler.active_client)
    ...
    def on_message(self, message):
        ...
        elif data[0] in (self.MSG_SUBSCRIBE, self.MSG_UNSUBSCRIBE, self.MSG_PUBLISH):
