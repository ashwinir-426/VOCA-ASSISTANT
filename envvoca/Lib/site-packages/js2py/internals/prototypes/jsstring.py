...
class StringPrototype:
    ...
    def concat(this, args):
        cok(this)
        return to_string(this) + "".join(map(to_string, args))
    ...
    def replace(this, args):
        ...
        if GetClass(searchValue) == "RegExp" and searchValue.glob:
            ...
            for e in re.finditer(searchValue.pat, s):
                ...
                if func:
                    ...
                    res += to_string(
                        replaceValue.call(
                            this, ensure_js_types(call_args, space=args.space)
                        )
                    )
                else:
        ...
        if func:
            ...
            # convert all types to JS before Js bytecode call...
            res += to_string(
                replaceValue.call(this, ensure_js_types(call_args, space=args.space))
            )
        else:
