...
def Uint32Array():
    ...
    if isinstance(a, PyJsNumber):  # length
        ...
        isinstance(a, PyJsArray)
        or isinstance(a, TypedArray)
        or isinstance(a, PyJsArrayBuffer)
        ...
        temp = Js(
            numpy.frombuffer(a.obj, dtype=numpy.uint32, count=length, offset=offset)
        )
        temp.put("length", Js(length))
        return temp
...
Uint32ArrayPrototype.define_own_property(
    "constructor",
    {"value": Uint32Array, "enumerable": False, "writable": True, "configurable": True},
)

Uint32ArrayPrototype.define_own_property(
    "BYTES_PER_ELEMENT",
    {"value": Js(4), "enumerable": False, "writable": False, "configurable": False},
)
