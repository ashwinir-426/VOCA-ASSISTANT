...
Array.define_own_property(
    "isArray",
    {"value": isArray, "enumerable": False, "writable": True, "configurable": True},
)
...
ArrayPrototype.define_own_property(
    "constructor",
    {"value": Array, "enumerable": False, "writable": True, "configurable": True},
)
