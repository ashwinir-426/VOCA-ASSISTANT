...
class Test_invariant(unittest.TestCase):
    ...
    def test_w_multiple(self):
        ...
        self.assertEqual(
            getattr(Foo, TAGGED_DATA, None), {"invariants": [_check, _another_check]}
        )
...
class Test_taggedValue(unittest.TestCase):
    ...
    def test_w_multiple(self):
        ...
        self.assertEqual(
            getattr(Foo, TAGGED_DATA, None), {"bar": ["baz"], "qux": "spam"}
        )
    ...
    def test_w_multiple_overwriting(self):
        ...
        self.assertEqual(
            getattr(Foo, TAGGED_DATA, None), {"bar": "frob", "qux": "spam"}
        )
...
class InterfaceClassTests(unittest.TestCase):
    ...
    def test___hash___normal(self):
        ...
        self.assertEqual(
            hash(iface), hash(("HashMe", "zope.interface.tests.test_interface"))
        )
...
class InterfaceTests(unittest.TestCase):
    ...
    def test_invariant_nested(self):
        ...
        self.assertEqual(
            ISubInvariant.getTaggedValue("invariants"), [_barGreaterThanFoo]
        )
        has_invariant = HasInvariant()
        ...
        has_invariant.bar = 1
        self._errorsEqual(
            has_invariant, 1, ["Please, Boo MUST be greater than Foo!"], ISubInvariant
        )
        ...
        self._errorsEqual(
            has_invariant,
            2,
            ["If Foo, then Bar!", "Please, Boo MUST be greater than Foo!"],
            ISubInvariant,
        )
    ...
    def test_invariant_mutandis(self):
        ...
        has_invariant.bar = 1
        self._errorsEqual(
            has_invariant, 1, ["Please, Boo MUST be greater than Foo!"], IInvariant
        )
        # and if we set foo to a positive number and boo to 0, we'll
        # get both errors!
        has_invariant.foo = 1
