...
class TestImplements(NameAndModuleComparisonTestsMixin, unittest.TestCase):
    ...
    def test_sort(self):
        ...
        self.assertGreater(None, implementedBy(A))
    ...
    def test_proxy_equality(self):
        ...
        # test both
        self.assertEqual(implementedByA, implementedByA)
...
class Test_implementedByFallback(unittest.TestCase):
    ...
    def test_w_None_no_bases_w_class(self):
        ...
        self.assertEqual(
            spec.__name__, "zope.interface.tests.test_declarations.FooImplementedNone"
        )
    ...
    def test_super_multi_level_multi_inheritance(self):
        ...
        self.assertEqual(
            list(self._callFUT(d)), [IDerived, IUnrelated, IM1, IBase, IM2]
        )
...
class _ImplementsTestMixin:
    ...
    def _check_implementer(
        self, Foo, orig_spec=None, spec_name=__name__ + ".Foo", inherit="not given"
    ):
        from zope.interface.declarations import ClassProvides
...
class ProvidesClassStrictTests(ProvidesClassTests):
    ...
    def test_overlapping_interfaces_corrected(self):
        ...
        self.assertEqual(
            spec.__sro__,
            (spec, implementedBy(Base), IBase, implementedBy(object), Interface),
        )
...
class TestProvidesClassRepr(unittest.TestCase):
    ...
    def test__repr__(self):
        ...
        self.assertEqual(
            repr(inst), "directlyProvides(TestProvidesClassRepr, IFoo, IBar)"
        )
    ...
    def test__repr__module_provides_cached_shared(self):
        ...
        self.assertEqual(
            repr(inst), "directlyProvides(('some.module', 'another.module'), IFoo)"
        )
    ...
    def test__repr__duplicate_names(self):
        ...
        self.assertEqual(
            repr(inst), "directlyProvides(TestProvidesClassRepr, IFoo, IBaz, mod2.IFoo)"
        )
    ...
    def test__repr__providedBy_alsoProvides(self):
        ...
        inst = providedBy(foo)
        self.assertEqual(
            repr(inst), "directlyProvides(Foo, IBar, classImplements(Foo, IFoo))"
        )
...
class TestClassProvidesRepr(unittest.TestCase):
    ...
    def test__repr__duplicate_names(self):
        ...
        self.assertEqual(
            repr(inst), "directlyProvides(TestClassProvidesRepr, IFoo, IBaz, mod2.IFoo)"
        )
    ...
    def test__repr__implementedBy_generic_callable(self):
        ...
        self.assertEqual(repr(inst), f"classImplements({__name__}.?)")
...
class Test_moduleProvides(unittest.TestCase):
    ...
    def test_called_from_function(self):
        ...
        IFoo = InterfaceClass("IFoo")
        globs = {
            "__name__": "zope.interface.tests.foo",
...
class Test_getObjectSpecification(
    Test_getObjectSpecificationFallback, OptimizationTestMixin
):
    # Repeat tests for C optimizations
...
class Test_providedByFallback(unittest.TestCase):
    ...
    def test_catches_only_AttributeError_on_providedBy(self):
        MissingSomeAttrs.test_raises(
            self, self._callFUT, expected_missing="__providedBy__", __class__=object
        )
