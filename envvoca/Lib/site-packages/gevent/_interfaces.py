...
class ILoop(Interface):
    ...
    default = schema.Bool(
        description="Boolean indicating whether this is the default loop",
        required=True,
        readonly=True,
    )

    approx_timer_resolution = schema.Float(
        description="Floating point number of seconds giving (approximately) the minimum "
...
class ICallback(Interface):
    ...
    pending = schema.Bool(description="Has this callback run yet?", readonly=True)
